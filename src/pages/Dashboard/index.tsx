...
export const Dashboard = () => {
  const array = [
    ...
    { id: '2', title: 'Internet', category: 'web', cost: 29.99 },
 ...
 const handleNavigateToAddNewExpanse = () => {
  ...
  return (
    <TemplateContainer>
      ...
      <main className='w-full bg-purple-50 max-w-screen-lg h-5/6 grid overflow-y-scroll content-start grid-cols-3 gap-4 p-4 pb-8'>
          {array.map((item) => (
           <Card 
           key={item.id} 
           title={item.title} 
